...
const ConcurForm = ({ user, packet }) => {
  ...
  const [concur, setConcur] = useState(false);
          ...
          <Card>
            <Card.Body>
              ...
              <Form.Group controlId="concurred" className="mb-4">
                <Form.Check
                  type="checkbox"
                  label="I concur with all actions taken in this packet"
                  checked={concur}
                  onChange={(e) => setConcur(e.target.checked)}
                  required
                />
              </Form.Group>
